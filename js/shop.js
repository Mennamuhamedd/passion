  ...
  class UI {
    displayProduts(products) {
      ...
      products.forEach(product => {
        results += `
          <div class="col-lg-3 col-md-6 col-12 ${product.fields.filter}"">
          ...
          <div class="carousel-img-des">
            ...
            `;
        $(".shop__products").html(results);
      });
      $(".filter-section").click(e => {
        let filterValue = e.target.innerText;
        if (filterValue === "valentien") {
          $(".valentien-img").removeClass("hiden");
          $(".mother-day").addClass("hiden");
        } else if (filterValue === "Mother's Day") {
          $(".mother-day").removeClass("hiden");
          $(".valentien-img").addClass("hiden");
